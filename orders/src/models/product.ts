...
productSchema.methods.hasStock = async function (requestedQuantity: number) {
  // Đơn giản: kiểm tra quantity hiện tại trong snapshot của Orders service.
  // Giá trị này được sync từ Product service qua events (product.created / product.updated).
