                    ...
                    <div className="card card-product">
                        <div className="card-body">
                            ...
                            <ul className="list-unstyled mb-0">
                                <li className="mb-2"><strong>Title:</strong> {product.title}</li>
                                <li className="mb-2"><strong>Price:</strong> ${product.price}</li>
                                <li className="mb-2"><strong>Stock:</strong> {stockStatus}</li>
                                {product.userId && (
                                    <li className="mb-2"><strong>Seller:</strong> {product.userId}</li>
                                )}
                            </ul>
                        </div>
                    </div>
                ...
                <div className="col-12 col-lg-4">
                    <div className="card card-product">
                        <div className="card-body d-grid gap-2">
                            ...
                            <Link className="btn btn-outline-secondary" href="/">Back to products</Link>
                        </div>
                    </div>
                </div>
            </div>
